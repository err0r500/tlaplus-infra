...
\@x{}\moduleLeftDash\@xx{ {\MODULE} UpdateCluster}\moduleRightDash\@xx{}%
...
\@x{\@s{16.4} confOK ,\,}%
\@y{\@s{0}%
 are we able to get a valid conf \.{?}
}%
\@xx{}%
\@x{\@s{16.4} lastVSubmitted ,\,}%
\@y{\@s{0}%
 just to keep track of the order of submissions
}%
\@xx{}%
\@x{\@s{16.4} lastVOK ,\,}%
\@y{\@s{0}%
 last \ensuremath{v} where the cluster was fully applied (used by rollback)
}%
\@xx{}%
\@x{\@s{16.4} toApply ,\,\@s{4.67}}%
\@y{\@s{0}%
 the version to apply (\ensuremath{lastVsubmitted} that passed the initial
 tests)
}%
\@xx{}%
\@x{\@s{16.4} cluster ,\,\@s{9.23}}%
\@y{\@s{0}%
 last cluster fully deployed
}%
\@xx{}%
\@x{\@s{16.4} requests ,\,}%
\@y{\@s{0}%
 the \ensuremath{st} of all requests (\ensuremath{requests[req]})
}%
\@xx{}%
\@x{\@s{16.4} workers ,\,}%
\@x{\@s{16.4} lock}%
 \@x{ vars \.{\defeq} {\langle} confOK ,\, lastVSubmitted ,\, lastVOK ,\,
 toApply ,\, cluster ,\, requests ,\, workers ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
\@x{ TypeInvariants \.{\defeq}}%
\@x{\@s{16.4} \.{\land} confOK \.{\in} {\BOOLEAN}}%
\@y{\@s{0}%
 won\mbox{'}t change for a specific behavior
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} lock \.{\in} {\BOOLEAN}}%
\@x{\@s{16.4} \.{\land} cluster . st \.{\in} \{}%
\@x{\@s{31.61}\@w{idle} ,\,}%
\@x{\@s{31.61}\@w{starting} ,\,}%
\@x{\@s{31.61}\@w{partial} ,\,}%
\@x{\@s{31.61}\@w{failed}}%
\@x{\@s{31.61} \}}%
 \@x{\@s{16.4} \.{\land} \A\, r \.{\in} \_Requests \.{:} requests [ r ] . st
 \.{\in} \{}%
\@x{\@s{31.61}\@w{waiting} ,\,}%
\@y{\@s{0}%
 the request (req) hasn\mbox{'}t been submitted yet
}%
\@xx{}%
\@x{\@s{31.61}\@w{submitted} ,\,}%
\@y{\@s{0}%
 req has been submitted
}%
\@xx{}%
\@x{\@s{31.61}\@w{rejected} ,\,}%
\@y{\@s{0}%
 req has been rejected (auth problem)
}%
\@xx{}%
\@x{\@s{31.61}\@w{valid} ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{31.61}\@w{processing} ,\,}%
\@y{\@s{0}%
 the processing of the req has started
}%
\@xx{}%
\@x{\@s{31.61}\@w{partial} ,\,}%
\@y{\@s{0}%
 req is partially applied (the infra is partially modified)
}%
\@xx{}%
\@x{\@s{31.61}\@w{partialFailure} ,\,}%
\@y{\@s{0}%
 req failed in the middle of an application
}%
\@xx{}%
\@x{\@s{31.61}\@w{success} ,\,}%
\@y{\@s{0}%
 req has been sucessfully applied
}%
\@xx{}%
\@x{\@s{31.61}\@w{failure} ,\,\@s{4.33}}%
\@y{\@s{0}%
 the req failed before modifying the cluster
}%
\@xx{}%
\@x{\@s{31.61}\@w{rolledback}}%
\@y{\@s{0}%
 the req has been \ensuremath{rolledback
}}%
\@xx{}%
\@x{\@s{31.61} \}}%
 \@x{\@s{16.4} \.{\land} \A\, w \.{\in} \_Workers \.{:} workers [ w ] . st
 \.{\in} \{}%
\@x{\@s{31.61}\@w{waiting} ,\,}%
\@x{\@s{31.61}\@w{starting} ,\,}%
\@x{\@s{31.61}\@w{working}}%
...
\end{lcom}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} requests \.{=} [ r \.{\in} \_Requests \.{\mapsto} [
 st \.{\mapsto}\@w{waiting} ,\, v \.{\mapsto} NULL ] ]}%
 \@x{\@s{16.4} \.{\land} workers\@s{4.76} \.{=} [ w \.{\in} \_Workers
 \.{\mapsto} [ st \.{\mapsto}\@w{waiting} ,\, v \.{\mapsto} NULL ] ]}%
 \@x{\@s{16.4} \.{\land} cluster\@s{9.23} \.{=} [ v \.{\mapsto} 0 ,\, st
 \.{\mapsto}\@w{idle} ]}%
\@x{\@s{16.4} \.{\land} lastVOK \.{=} 0}%
\@x{\@s{16.4} \.{\land} lastVSubmitted \.{=} 0}%
\@x{\@s{16.4} \.{\land} toApply \.{=} 0}%
\@x{\@s{16.4} \.{\land} confOK \.{\in} {\BOOLEAN}}%
\@x{\@s{16.4} \.{\land} lock \.{=} {\FALSE}}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Actions
...
\@x{ Submit ( r ) \.{\defeq}}%
\@y{\@s{0}%
 update request received from the user
}%
\@xx{}%
\@x{\@s{16.4} \.{\LET} newV \.{\defeq} lastVSubmitted \.{+} 1 \.{\IN}}%
\@x{\@s{16.4} \.{\land} requests [ r ] . st \.{=}\@w{waiting}}%
\@x{\@s{16.4} \.{\land} lastVSubmitted \.{'} \.{=} newV}%
 \@x{\@s{16.4} \.{\land} requests \.{'} \.{=} [ requests {\EXCEPT} {\bang} [ r
 ] . st \.{=}\@w{submitted} ,\, {\bang} [ r ] . v \.{=} newV ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVOK ,\, toApply
 ,\, cluster ,\, workers ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
\@x{ Initialcheck ( r ) \.{\defeq}}%
\@y{\@s{0}%
 request validation (auth, quotas\.{\dots})
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} requests [ r ] . st \.{=}\@w{submitted}}%
\@x{\@s{16.4} \.{\land} \E\, ok \.{\in} {\BOOLEAN} \.{:}}%
\@x{\@s{31.61} {\IF} ok}%
\@x{\@s{47.86} \.{\THEN}}%
 \@x{\@s{64.26} requests \.{'} \.{=} [ requests {\EXCEPT}\@s{4.1} {\bang} [ r
 ] . st \.{=}\@w{valid} ]}%
\@x{\@s{47.86} \.{\ELSE}}%
 \@x{\@s{64.26} requests \.{'} \.{=} [ requests {\EXCEPT}\@s{4.1} {\bang} [ r
 ] . st \.{=}\@w{rejected} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, cluster ,\, workers ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
\@x{ PushToPending ( r ) \.{\defeq}}%
\@y{\@s{0}%
 the request is pushed to queue
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} requests [ r ] . st \.{=}\@w{valid}}%
\@x{\@s{16.4} \.{\land} {\IF} toApply \.{<} requests [ r ] . v}%
\@x{\@s{31.61} \.{\THEN} \.{\land} toApply \.{'} \.{=} requests [ r ] . v}%
 \@x{\@s{62.92} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, cluster ,\, requests ,\, workers ,\, lock {\rangle}}%
 \@x{\@s{31.61} \.{\ELSE} \.{\land} requests \.{'} \.{=} [ requests {\EXCEPT}
 {\bang} [ r ] . st \.{=}\@w{rejected} ]}%
 \@x{\@s{62.92} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, cluster ,\, workers ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
\@x{ SpawnWorker ( w ) \.{\defeq}}%
\@y{\@s{0}%
 spawns a new worker
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} workers [ w ] . st \.{=}\@w{waiting}}%
\@x{\@s{16.4} \.{\land} lock \.{=} {\FALSE}}%
\@x{\@s{16.4} \.{\land}\@s{4.1} \.{\lor} cluster . st \.{=}\@w{idle}}%
\@x{\@s{31.61} \.{\lor} cluster . st \.{=}\@w{failed}}%
\@x{\@s{16.4} \.{\land} {\IF} cluster . st \.{=}\@w{idle}}%
\@x{\@s{31.61} \.{\THEN}}%
 \@x{\@s{48.01} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . v \.{=} toApply ,\, {\bang} [ w ] . st \.{=}\@w{starting} ]}%
\@x{\@s{31.61} \.{\ELSE}}%
 \@x{\@s{48.01} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . v \.{=} lastVOK ,\, {\bang} [ w ] . st \.{=}\@w{starting} ]}%
\@x{\@s{16.4} \.{\land} lock \.{'} \.{=} {\TRUE}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, requests ,\, cluster {\rangle}}%
\@pvspace{24.0pt}%
\@x{ ApplyStart ( w ) \.{\defeq}}%
\@y{\@s{0}%
 the cluster starts to be modified
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} workers [ w ] . st \.{=}\@w{starting}}%
 \@x{\@s{16.4} \.{\land} {\IF} \.{\lor} workers [ w ] . v \.{=}
 lastVSubmitted}%
\@x{\@s{39.66} \.{\lor} workers [ w ] . v \.{=} lastVOK}%
\@y{\@s{0}%
 rollingback
}%
\@xx{}%
...
\@x{\@s{48.01} {\IF} confOK}%
\@x{\@s{64.26} \.{\THEN}}%
 \@x{\@s{80.66} \.{\land} cluster \.{'}\@s{4.47} \.{=} [ v \.{\mapsto} workers
 [ w ] . v ,\, st \.{\mapsto}\@w{partial} ]}%
 \@x{\@s{80.66} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . st \.{=}\@w{working} ]}%
 \@x{\@s{80.66} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, requests ,\, lock {\rangle}}%
\@x{\@s{64.26} \.{\ELSE}}%
\@x{\@s{80.66} \.{\land} lock \.{'} \.{=} {\FALSE}}%
 \@x{\@s{80.66} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . st \.{=}\@w{waiting} ,\, {\bang} [ w ] . v \.{=} NULL ]}%
 \@x{\@s{80.66} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, cluster ,\, requests {\rangle}}%
\@x{\@s{31.61} \.{\ELSE}}%
 \@x{\@s{48.01} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . st \.{=}\@w{waiting} ,\, {\bang} [ w ] . v \.{=} NULL ]}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, cluster ,\, requests ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
\@x{ ApplyFinish ( w ) \.{\defeq}}%
\@y{\@s{0}%
 the cluster update finishes
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} workers [ w ] . st \.{=}\@w{working}}%
\@x{\@s{16.4} \.{\land} lock \.{'} \.{=} {\FALSE}}%
\@x{\@s{16.4} \.{\land} \E\, ok\@s{2.22} \.{\in} {\BOOLEAN} \.{:}}%
\@x{\@s{31.61} {\IF} ok \.{\lor} workers [ w ] . v \.{=} lastVOK\@s{4.1}}%
\@y{\@s{0}%
 rollback always works
}%
\@xx{}%
\@x{\@s{47.86} \.{\THEN}}%
 \@x{\@s{64.26} \.{\land} cluster \.{'}\@s{9.23} \.{=}\@s{4.1} [ cluster
 {\EXCEPT} {\bang} . st \.{=}\@w{idle} ]}%
\@x{\@s{64.26} \.{\land} lastVOK \.{'} \.{=} workers [ w ] . v}%
 \@x{\@s{64.26} \.{\land} workers \.{'}\@s{4.76} \.{=} [ workers {\EXCEPT}
 {\bang} [ w ] . st \.{=}\@w{waiting} ,\, {\bang} [ w ] . v \.{=} NULL ]}%
 \@x{\@s{64.26} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 toApply ,\, requests {\rangle}}%
\@x{\@s{47.86} \.{\ELSE}}%
 \@x{\@s{64.26} \.{\land} cluster \.{'}\@s{4.47} \.{=}\@s{4.1} [ cluster
 {\EXCEPT} {\bang} . st \.{=}\@w{failed} ]}%
 \@x{\@s{64.26} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
 ] . st \.{=}\@w{waiting} ,\, {\bang} [ w ] . v \.{=} NULL ]}%
 \@x{\@s{64.26} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastVSubmitted ,\,
 lastVOK ,\, toApply ,\, requests {\rangle}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Requirements
\end{cpar}%
\end{lcom}%
\@x{ NoConcurrentUpdate \.{\defeq}}%
 \@x{\@s{16.4} {\Box} ( Cardinality ( \{ r \.{\in} {\DOMAIN} requests \.{:}
 requests [ r ] . st \.{=}\@w{working} \} ) \.{<} 2 )}%
\@pvspace{8.0pt}%
\@x{ NoPartialUpdateTermination \.{\defeq}}%
\@y{\@s{0}%
 we don’t want the cluster to end up in a partially update \ensuremath{st
}}%
\@xx{}%
\@x{\@s{16.4} {\Diamond} {\Box} ( cluster . st \.{=}\@w{idle} )}%
\@pvspace{8.0pt}%
\@x{ EveryReqIsProcessed \.{\defeq}}%
 \@x{\@s{16.4} {\Diamond} {\Box} ( {\lnot} \E\, r \.{\in} \_Requests \.{:}
 requests [ r ] . st \.{=}\@w{waiting} )}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Spec
...
\@pvspace{24.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, r \.{\in} \_Requests \.{:}}%
\@x{\@s{40.02} \.{\lor} Submit ( r )}%
\@x{\@s{40.02} \.{\lor} Initialcheck ( r )}%
\@x{\@s{40.02} \.{\lor} PushToPending ( r )}%
\@x{\@s{16.4} \.{\lor} \E\, w \.{\in} \_Workers \.{:}}%
\@x{\@s{42.45} \.{\lor} SpawnWorker ( w )}%
\@x{\@s{42.45} \.{\lor} ApplyStart ( w )}%
\@x{\@s{42.45} \.{\lor} ApplyFinish ( w )}%
\@pvspace{16.0pt}%
 \@x{ Fairness \.{\defeq} \A\, r \.{\in} \_Requests ,\, w \.{\in} \_Workers
 \.{:}}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( Submit ( r ) )}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( Initialcheck ( r ) )}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( PushToPending ( r ) )}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( SpawnWorker ( w ) )}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( ApplyStart ( w ) )}%
\@x{\@s{67.58} \.{\land} {\WF}_{ vars} ( ApplyFinish ( w ) )}%
\@pvspace{16.0pt}%
\@x{ Spec \.{\defeq}}%
...
\@pvspace{32.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} ( TypeInvariants )}%
\@x{ {\THEOREM} Spec \.{\implies} NoPartialUpdateTermination}%
\@x{}%
\@y{%
 \ensuremath{{\THEOREM}} \ensuremath{Spec \.{\implies}
 NoApplicationOfOutdatedReq
}}%
\@xx{}%
\@x{}%
\@y{%
 \ensuremath{{\THEOREM}} \ensuremath{Spec \.{\implies}
 EveryReqInQueueIsProcessed
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
