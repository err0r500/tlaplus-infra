...
\@y{\@s{0}%
 the version to apply (last request that passed the initial tests)
}%
\@xx{}%
...
\@xx{}%
\@x{\@s{16.4} clusterUpdating}%
\@y{\@s{0}%
 damn, I use a lock\.{\dots}
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
...
\@pvspace{8.0pt}%
 ...
 ,\, cluster ,\, requests ,\, workers ,\, clusterUpdating {\rangle}}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} clusterUpdating \.{\in} {\BOOLEAN}}%
...
\@x{\@s{16.4} \.{\land} confOK \.{\in} {\BOOLEAN}}%
\@x{\@s{16.4} \.{\land} clusterUpdating \.{=} {\FALSE}}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Actions
...
\@x{\@s{16.4} \.{\land} reqCounter \.{'} \.{=} newV}%
 ...
 ,\, cluster ,\, workers ,\, clusterUpdating {\rangle}}%
\@pvspace{16.0pt}%
...
\@x{\@s{16.4} \.{\land} {\IF} toApply \.{<} requests [ r ] . v}%
 \@x{\@s{31.61} \.{\THEN} \.{\land} requests \.{'} \.{=} [ requests
 {\EXCEPT}\@s{4.1} {\bang} [ r ] . st \.{=}\@w{valid} ]}%
\@x{\@s{62.92} \.{\land} toApply \.{'} \.{=} requests [ r ] . v}%
 \@x{\@s{62.92} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
 lastVOK ,\, cluster ,\, workers ,\, clusterUpdating {\rangle}}%
 \@x{\@s{31.61} \.{\ELSE} \.{\land} requests \.{'} \.{=} [ requests {\EXCEPT}
 {\bang} [ r ] . st \.{=}\@w{rejected} ]}%
 \@x{\@s{62.92} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
 lastVOK ,\, toApply ,\, cluster ,\, workers ,\, clusterUpdating {\rangle}}%
\@pvspace{16.0pt}%
...
\@x{\@s{16.4} \.{\land} clusterUpdating \.{'} \.{=} {\TRUE}}%
...
\@x{\@s{64.26} \.{\THEN}}%
 ...
 lastVOK ,\, toApply ,\, requests ,\, clusterUpdating {\rangle}}%
\@x{\@s{64.26} \.{\ELSE}}%
\@x{\@s{80.66} \.{\land} clusterUpdating \.{'} \.{=} {\FALSE}}%
 \@x{\@s{80.66} \.{\land} workers \.{'} \.{=} [ workers {\EXCEPT} {\bang} [ w
...
\@x{\@s{48.01} \.{\land} clusterUpdating \.{'} \.{=} {\FALSE}}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 to differenciate it from the original last \ensuremath{VOK} (in realworld,
 could be \ensuremath{conf \.{+}} timestamp)
}%
\@xx{}%
\@x{\@s{16.4} lastVOK \.{+} 10}%
\@pvspace{16.0pt}%
...
\@x{ NoConcurrentUpdate \.{\defeq}}%
 \@x{\@s{16.4} {\Box} ( Cardinality ( \{ w \.{\in} {\DOMAIN} workers \.{:}
 workers [ w ] . st \.{=}\@w{working} \} ) \.{<} 2 )}%
\@pvspace{8.0pt}%
...
\@x{ {\THEOREM} Spec \.{\implies} NoConcurrentUpdate}%
\@x{ {\THEOREM} Spec \.{\implies} NoPartialUpdateTermination}%
\@x{ {\THEOREM} Spec \.{\implies} EveryReqIsProcessed}%
\@x{}\bottombar\@xx{}%
\end{document}
