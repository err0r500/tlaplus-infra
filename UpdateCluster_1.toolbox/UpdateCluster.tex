...
\@xx{}%
\@x{\@s{16.4} lastSubmitted ,\,}%
\@y{\@s{0}%
 last cluster submitted
}%
\@xx{}%
\@x{\@s{16.4} clusterState ,\,}%
\@y{\@s{0}%
...
\@x{\@s{16.4} reqState}%
\@y{\@s{0}%
 the state of all requests (\ensuremath{reqState[req]})
}%
\@xx{}%
 \@x{ vars \.{\defeq} {\langle} confOK ,\, clusterState ,\, reqState ,\, queue
 ,\, lastSubmitted {\rangle}}%
\@pvspace{16.0pt}%
\@x{ NoConcurrentUpdate \.{\defeq}}%
 \@x{\@s{16.4} Cardinality ( \{ r \.{\in} {\DOMAIN} reqState \.{:} reqState [
 r ] . status \.{=}\@w{partial} \} ) \.{<} 2}%
\@pvspace{16.0pt}%
\@x{ TypeInvariants \.{\defeq}}%
\@x{\@s{8.2} \.{\land} confOK \.{\in} {\BOOLEAN}}%
\@y{\@s{0}%
 won\mbox{'}t change for a specific behavior
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} NoConcurrentUpdate}%
 \@x{\@s{8.2} \.{\land} \A\, r \.{\in} Reqs \.{:} reqState [ r ] . status
 \.{\in} \{}%
\@x{\@s{16.4}\@w{waiting} ,\,}%
\@y{\@s{0}%
 the request (\ensuremath{req}) hasn\mbox{'}t been submitted yet
}%
\@xx{}%
\@x{\@s{16.4}\@w{submitted} ,\,}%
\@y{\@s{0}%
 \ensuremath{req} has been submitted
}%
\@xx{}%
\@x{\@s{16.4}\@w{rejected} ,\,}%
\@y{\@s{0}%
 \ensuremath{req} has been rejected (auth problem)
}%
\@xx{}%
\@x{\@s{16.4}\@w{valid} ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4}\@w{processing} ,\,}%
\@y{\@s{0}%
 the processing of the \ensuremath{req} has started
}%
\@xx{}%
\@x{\@s{16.4}\@w{partial} ,\,}%
\@y{\@s{0}%
 \ensuremath{req} is partially applied (the infra is partially modified)
}%
\@xx{}%
\@x{\@s{16.4}\@w{partialFailure} ,\,}%
\@y{\@s{0}%
 \ensuremath{req} failed in the middle of an application
}%
\@xx{}%
\@x{\@s{16.4}\@w{success} ,\,}%
\@y{\@s{0}%
 \ensuremath{req} has been sucessfully applied
}%
\@xx{}%
\@x{\@s{16.4}\@w{failure} ,\,\@s{4.33}}%
\@y{\@s{0}%
 the \ensuremath{req} failed before modifying the cluster
}%
\@xx{}%
\@x{\@s{16.4}\@w{rolledback}}%
\@y{\@s{0}%
 the \ensuremath{req} has been \ensuremath{rolledback
}}%
\@xx{}%
\@x{\@s{16.4} \}}%
\@pvspace{24.0pt}%
...
\end{lcom}%
\@x{ Init \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} reqState \.{=} [ r \.{\in} Reqs \.{\mapsto} [ status
 \.{\mapsto}\@w{waiting} ,\, rank \.{\mapsto} NULL ] ]}%
 \@x{\@s{16.4} \.{\land} clusterState \.{=} [ req \.{\mapsto} NULL ,\,
 complete \.{\mapsto} {\TRUE} ]}%
\@x{\@s{16.4} \.{\land} lastSubmitted \.{=} 0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\LET} currSubmitRank \.{\defeq} lastSubmitted \.{+} 1
 \.{\IN}}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{waiting}}%
\@x{\@s{16.4} \.{\land} lastSubmitted \.{'} \.{=} currSubmitRank}%
 \@x{\@s{16.4} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [ r
 ] . status \.{=}\@w{submitted} ,\, {\bang} [ r ] . rank \.{=} currSubmitRank
 ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, queue ,\,
 clusterState {\rangle}}%
\@pvspace{16.0pt}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{submitted}}%
\@x{\@s{16.4} \.{\land} \E\, ok \.{\in} {\BOOLEAN} \.{:}}%
\@x{\@s{31.61} {\IF} ok}%
\@x{\@s{47.86} \.{\THEN}}%
 \@x{\@s{64.26} reqState \.{'} \.{=} [ reqState {\EXCEPT}\@s{4.1} {\bang} [ r
 ] . status \.{=}\@w{valid} ]}%
\@x{\@s{47.86} \.{\ELSE}}%
 \@x{\@s{64.26} reqState \.{'} \.{=} [ reqState {\EXCEPT}\@s{4.1} {\bang} [ r
 ] . status \.{=}\@w{rejected} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, queue ,\,
 clusterState ,\, lastSubmitted {\rangle}}%
\@pvspace{16.0pt}%
\@x{ PushToQueue ( r ) \.{\defeq}}%
\@y{\@s{0}%
 the request is pushed to queue
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{valid}}%
\@x{\@s{16.4} \.{\land} queue \.{'} \.{=} queue \.{\cup} \{ r \}}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqState ,\,
 clusterState ,\, lastSubmitted {\rangle}}%
\@pvspace{16.0pt}%
\@x{ ProcessQueue \.{\defeq}\@s{4.1}}%
\@y{\@s{0}%
 a request in queue is processed (order of submission not took into account)
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} queue \.{\neq} \{ \}}%
\@x{\@s{16.4} \.{\land} \E\, r \.{\in} queue \.{:}}%
\@x{\@s{31.61} \.{\land} queue \.{'} \.{=} queue \.{\,\backslash\,} \{ r \}}%
 \@x{\@s{31.61} \.{\land} reqState \.{'} \.{=}\@s{4.1} [ reqState {\EXCEPT}
 {\bang} [ r ] . status \.{=}\@w{processing} ]}%
 \@x{\@s{31.61} \.{\land} {\UNCHANGED} {\langle} confOK ,\, clusterState ,\,
 lastSubmitted {\rangle}}%
\@pvspace{16.0pt}%
\@x{ StartApply ( r ) \.{\defeq}}%
\@y{\@s{0}%
 the cluster starts to be modified
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . rank \.{=} lastSubmitted}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{processing}}%
\@x{\@s{16.4} \.{\land} clusterState . complete \.{=} {\TRUE}}%
 \@x{\@s{16.4} \.{\land} {\lnot} \E\, x \.{\in} {\DOMAIN} reqState \.{:}
 reqState [ x ] . status \.{=}\@w{partial}}%
\@y{\@s{0}%
 don\mbox{'}t attempt if an attempt is already on-going
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} {\IF} confOK}%
\@x{\@s{31.61} \.{\THEN}}%
 \@x{\@s{48.01} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [
 r ] . status \.{=}\@w{partial} ]}%
 \@x{\@s{48.01} \.{\land} clusterState \.{'} \.{=} [ req \.{\mapsto} r ,\,
 complete \.{\mapsto} {\FALSE} ]}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastSubmitted ,\,
 queue {\rangle}}%
\@x{\@s{31.61} \.{\ELSE}}%
 \@x{\@s{48.01} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [
 r ] . status \.{=}\@w{failure} ]}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} confOK ,\, clusterState ,\,
 lastSubmitted ,\, queue {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CompleteApply ( r ) \.{\defeq}}%
\@y{\@s{0}%
 the cluster update finishes
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{partial}}%
\@x{\@s{16.4} \.{\land} \E\, ok \.{\in} {\BOOLEAN} \.{:}}%
\@x{\@s{31.61} {\IF} ok}%
\@x{\@s{47.86} \.{\THEN}}%
 \@x{\@s{64.26} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [
 r ] . status \.{=}\@w{success} ]}%
 \@x{\@s{64.26} \.{\land} clusterState \.{'} \.{=}\@s{4.1} [ clusterState
 {\EXCEPT} {\bang} . req \.{=} r ,\, {\bang} . complete \.{=} {\TRUE} ]}%
 \@x{\@s{64.26} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastSubmitted ,\,
 queue {\rangle}}%
\@x{\@s{47.86} \.{\ELSE}}%
 \@x{\@s{64.26} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [
 r ] . status \.{=}\@w{partialFailure} ]}%
 \@x{\@s{64.26} \.{\land} {\UNCHANGED} {\langle} confOK ,\, clusterState ,\,
 lastSubmitted ,\, queue {\rangle}}%
\@pvspace{16.0pt}%
\@x{ Rollback ( r ) \.{\defeq}}%
\@y{%
 we assume rollback always works if \ensuremath{confOK} (ie we shouldn’t have
 to rollback if conf not \ensuremath{OK} )
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} reqState [ r ] . status \.{=}\@w{partialFailure}}%
\@x{\@s{16.4} \.{\land} {\IF} confOK}%
\@x{\@s{31.61} \.{\THEN}}%
 \@x{\@s{48.01} \.{\land} reqState \.{'} \.{=} [ reqState {\EXCEPT} {\bang} [
 r ] . status \.{=}\@w{rolledback} ]}%
 \@x{\@s{48.01} \.{\land} clusterState \.{'} \.{=} [ clusterState {\EXCEPT}
 {\bang} . complete \.{=} {\TRUE} ]}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} confOK ,\, lastSubmitted ,\,
 queue {\rangle}}%
\@x{\@s{31.61} \.{\ELSE}}%
\@x{\@s{48.01} {\UNCHANGED} vars}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Requirements
...
\@xx{}%
\@x{\@s{16.4} {\Diamond} {\Box} ( clusterState . complete \.{=} {\TRUE} )}%
\@pvspace{16.0pt}%
\@x{ NoApplicationOfOutdatedReq \.{\defeq}}%
\@y{\@s{0}%
 we don’t want transition updates of successive requests
}%
\@xx{}%
 \@x{\@s{16.4} {\Box} ( \{ r \.{\in} {\DOMAIN} reqState \.{:} {\ENABLED}
 StartApply ( r ) \.{\land} reqState [ r ] . rank \.{\neq} lastSubmitted \}
 \.{=} \{ \} )}%
\@pvspace{16.0pt}%
\@x{ EveryReqInQueueIsProcessed \.{\defeq}}%
\@y{\@s{0}%
 we don’t want messages to stay in queue
}%
\@xx{}%
\@x{\@s{16.4} {\Diamond} {\Box} ( queue \.{=} \{ \} )}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Spec
...
\end{lcom}%
\@x{ Fairness \.{\defeq}}%
\@x{\@s{16.4} \A\, r \.{\in} Reqs \.{:}}%
\@x{\@s{27.72} \.{\land} {\WF}_{ vars} ( PushToQueue ( r ) )}%
\@x{\@s{27.72} \.{\land} {\WF}_{ vars} ( ProcessQueue )}%
\@x{\@s{27.72} \.{\land} {\WF}_{ vars} ( CompleteApply ( r ) )}%
\@x{\@s{27.72} \.{\land} {\WF}_{ vars} ( Rollback ( r ) )}%
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} ProcessQueue \.{\lor}}%
\@x{\@s{16.4} \E\, r \.{\in} Reqs \.{:}}%
\@x{\@s{27.72} \.{\lor} Submit ( r ) \.{\lor} Initialcheck ( r )}%
\@x{\@s{27.72} \.{\lor} PushToQueue ( r )}%
\@x{\@s{27.72} \.{\lor} StartApply ( r ) \.{\lor} CompleteApply ( r )}%
\@x{\@s{27.72} \.{\lor} Rollback ( r )}%
\@pvspace{16.0pt}%
\@x{ Spec \.{\defeq}}%
 \@x{\@s{8.2} \.{\land}\@s{0.16} Init \.{\land} {\Box} [ Next ]_{ vars}
 \.{\land} Fairness}%
\@pvspace{16.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} ( TypeInvariants )}%
\@x{ {\THEOREM} Spec \.{\implies} NoPartialUpdateTermination}%
\@x{ {\THEOREM} Spec \.{\implies} NoApplicationOfOutdatedReq}%
\@x{ {\THEOREM} Spec \.{\implies} EveryReqInQueueIsProcessed}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
