...
\@y{\@s{0}%
 the version to apply (last requets that passed the initial tests)
}%
\@xx{}%
...
\@xx{}%
\@x{\@s{16.4} requests ,\,\@s{7.46}}%
\@y{\@s{0}%
 the state of all requests
}%
\@xx{}%
\@x{\@s{16.4} workers ,\,}%
\@y{\@s{0}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 these variables are \ensuremath{tla\.{+}} details
}%
\@xx{}%
\@x{\@s{16.4} confOK ,\,}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} confOK ,\, reqCounter ,\, lastVOK ,\, toApply
 ,\, cluster ,\, requests ,\, workers ,\, lock {\rangle}}%
\@pvspace{16.0pt}%
...
\@xx{}%
\@x{\@s{16.4} \.{\LET} newV \.{\defeq} reqCounter \.{+} 1 \.{\IN}}%
\@x{\@s{16.4} \.{\land} requests [ r ] . st \.{=}\@w{waiting}}%
\@x{\@s{16.4} \.{\land} reqCounter \.{'} \.{=} newV}%
...
\@x{\@s{47.86} \.{\ELSE}}%
 ...
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
...
\@x{\@s{31.61} \.{\THEN} \.{\land} toApply \.{'} \.{=} requests [ r ] . v}%
 \@x{\@s{62.92} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
...
\@x{\@s{16.4} \.{\land} {\IF} workers [ w ] . v \.{\geq} toApply}%
\@x{\@s{31.61} \.{\THEN}}%
\@x{\@s{48.01} {\IF} confOK}%
\@x{\@s{64.26} \.{\THEN}}%
 ...
 \@x{\@s{80.66} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
...
\@x{\@s{48.01} \.{\land} lock \.{'} \.{=} {\FALSE}}%
 \@x{\@s{48.01} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
 lastVOK ,\, toApply ,\, cluster ,\, requests {\rangle}}%
\@pvspace{16.0pt}%
\@x{ RollbackVersion \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 to differenciate it from the original last \ensuremath{VOK
}}%
\@xx{}%
\@x{\@s{16.4} lastVOK \.{+} 10}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4} \.{\land} \E\, ok\@s{2.22} \.{\in} {\BOOLEAN} \.{:}}%
 \@x{\@s{31.61} {\IF} ok \.{\lor} workers [ w ] . v \.{=}
 RollbackVersion\@s{4.1}}%
\@y{\@s{0}%
...
\@x{\@s{64.26} \.{\land} lastVOK \.{'} \.{=} workers [ w ] . v}%
 ...
 \@x{\@s{64.26} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
...
\@x{\@s{64.26} \.{\land} {\IF} workers [ w ] . v \.{<} toApply}%
\@x{\@s{79.47} \.{\THEN}}%
\@y{\@s{0}%
 a newer version has been submitted
}%
\@xx{}%
 \@x{\@s{95.87} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
 lastVOK ,\, toApply ,\, requests {\rangle}}%
\@x{\@s{79.47} \.{\ELSE}}%
\@y{\@s{0}%
 let\mbox{'}s trigger a rollback
}%
\@xx{}%
\@x{\@s{95.87} \.{\land} toApply \.{'} \.{=} RollbackVersion}%
 \@x{\@s{95.87} \.{\land} {\UNCHANGED} {\langle} confOK ,\, reqCounter ,\,
 lastVOK ,\, requests {\rangle}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Requirements
